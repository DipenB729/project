    ...
    while($row = $result->fetch_assoc()) {
        ...
        if (mysqli_num_rows($second_result) > 0) {
            ...
            while($row2 = mysqli_fetch_assoc($second_result)) {
                echo "<ul class='product-item'>";
                echo "<li><strong>Name:</strong> " . $row2["name"] . "</li>";
                echo "<li><strong>Description:</strong> " . $row2["description"] . "</li>";
                echo "<li><strong>Price:</strong> " . $row2["price"] . "</li>";
